...
<body>
    <div class="dropdown">
     ...
     <button class="down" id="drop2">Wird mein Abonnement automatisch verlängert?</button>
     <p class="absatz" id="p2">Ja, Ihr Abonnement wird automatisch entsprechend Ihrem Zahlungszeitraum verlängert.</p><br>
     <button class="down" id="drop3">Was sind Widgets?</button>
